...
<template> 
  ...
  <div class="mb-8 flex justify-center space-x-6">
    ...
    class="border border-gray-300 rounder px-2 py-0.5 hover:bg-gray-200">Previus</button>
    <button 
    :disabled="page >= totalItems / itemsPerPage" 
    :class="{ 'opacity-50': page >= totalItems / itemsPerPage }"
    @click="$event => changePage(page + 1) " class="border border-gray-300 rounder px-2 py-0.5 hover:bg-gray-200">Previus</button>
  </div>
    <CountryList 
